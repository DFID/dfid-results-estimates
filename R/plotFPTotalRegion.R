...
plotFPTotalRegion <- function(data) {
  ...
  fp_total_region_plot  <-
    ...
    labs(
      ...
      subtitle = "Percentage of Family Planning (Total Users) Results by Region\n\n",
  ...
  pdf(file="figs/fp_total_region_plot.pdf",
      width=8,
      height=6,
      pointsize=12)
  print(fp_total_region_plot)
  dev.off()
}
