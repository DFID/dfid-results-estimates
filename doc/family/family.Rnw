...
\thispagestyle{empty}
<<echo=FALSE>>=
loadd(fp_additional_table)
loadd(fp_total_table)
...
an average of \Sexpr{unlist(fp_total_table[nrow(fp_total_table), "Average"]/1000000)} million
...
\Sexpr{unlist(fp_total_table[nrow(fp_total_table), "2019/20"]/1000000)}
...
\Sexpr{unlist(fp_additional_table[nrow(fp_additional_table), "Total"]/1000000)} million
