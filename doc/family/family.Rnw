...
\begin{figure}
	\centering
	\subfloat{{\includegraphics[width=0.8\textwidth]{../figs/fp_additional_region_plot} }}%
	\qquad
	\subfloat{{\includegraphics[width=0.8\textwidth]{../figs/fp_additional_fragility_plot} }}%
